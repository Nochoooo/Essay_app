...
Проект представляет собой веб-приложение с микросервисной архитектурой. Архитектура системы включает несколько ключевых сервисов, работающих в связке: ml_service, ui_service, Kafka, Zookeeper, Postgres. Для развертывания приложения можно использовать docker-compose или Kubernetes.
